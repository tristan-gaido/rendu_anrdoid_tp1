        ...
        boutonValider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nom.isEmpty() && !prenom.isEmpty() && !age.isEmpty() && !domaine.isEmpty() && !telephone.isEmpty()) {
                    Toast.makeText(HelloActivity.this, "Informations validées", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(HelloActivity.this, "Veuillez remplir tous les champs", Toast.LENGTH_SHORT).show();
                }
            }
        });
