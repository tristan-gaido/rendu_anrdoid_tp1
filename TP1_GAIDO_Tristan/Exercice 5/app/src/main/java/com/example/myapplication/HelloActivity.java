        ...
        boutonValider.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!nom.isEmpty() && !prenom.isEmpty() && !age.isEmpty() && !domaine.isEmpty() && !telephone.isEmpty()) {
                    ...
                    nomEditText.setBackgroundColor(Color.GREEN);
                    prenomEditText.setBackgroundColor(Color.GREEN);
                    ageEditText.setBackgroundColor(Color.GREEN);
                    domaineEditText.setBackgroundColor(Color.GREEN);
                    telephoneEditText.setBackgroundColor(Color.GREEN);
                } else {
